const en = {
  ...
  transactions: {
    ...
    step1Title: 'Client & operation',
    step2Title: 'Amount & package',
    step3Title: 'Confirmation',
    transactionType: 'Operation type',
    clientPhoneLabel: 'Client MoMo number',
    ...
    orEnterAmount: 'Or enter a custom amount',
    ...
    successSubtitle: 'The request has been sent to MTN MoMo',
    successRef: 'Reference: {{ref}}',
    processingNote: 'MTN will notify you by SMS once confirmed.',
    seeTransactions: 'See transactions',
    newTransactionButton: 'New transaction',

    // Errors
    invalidAmount: 'Invalid amount (minimum 1 XOF)',
    ...
    typeDescriptions: {
      deposit:     'Receive money from a client',
      withdrawal:  'Give money to a client',
      transfer:    'Send to another account',
      credit_sale: 'Phone credit top-up',
      data_sale:   'Data / internet plan activation',
      unlimited:   'Unlimited plan activation',
    },
